void initEquipes(Equipe *e1, Equipe *e2) {
	...
	// Personnages
	Perso p1 = {1, "Urssaf", 200, 200, 25, 15, 0, 50, 30, co1, co2, 0, 0, 0, 0};
	Perso p2 = {3, "Pikachu", 140, 140, 30, 20, 0, 55, 25, co3, co4, 0, 0, 0, 0};
	Perso p3 = {2, "Garen", 200, 200, 25, 15, 0, 50, 30, co5, co6, 0, 0, 0, 0};
	Perso p4 = {4, "Serpent Malicieux", 140, 140, 30, 20, 0, 55, 25, co7, co8, 0, 0, 0, 0};
	Perso p5 = {5, "Four", 250, 250, 30, 10, 0, 40, 35, co9, co10, 0, 0, 0, 0};
	Perso p6 = {6, "Ambulance", 250, 250, 30, 10, 0, 40, 30, co11, co1, 0, 0, 0, 0};
